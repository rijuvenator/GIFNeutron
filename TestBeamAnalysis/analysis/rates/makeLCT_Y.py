...
pretty = {
    ...
    1:['Algo0',    R.kBlue-1,  R.kFullSquare],
    2:['Algo1',    R.kOrange,  R.kFullTriangleUp],
    3:['Algo2',    R.kGreen+2, R.kFullCross],
    4:['Algo3',    R.kMagenta, R.kFullTriangleDown],
    5:['Algo4',    R.kCyan,    R.kFullDiamond],
}
