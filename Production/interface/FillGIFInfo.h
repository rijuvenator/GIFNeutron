...
class FillGIFRecHitInfo : public FillInfo
{
	...
	public:
		void fill(const CSCGeometry * theCSC,const CSCRecHit2DCollection& recHits, std::vector<std::vector<unsigned short int>> &chamlist);
};
...
class FillGIFCompInfo : public FillInfo
{
	...
	public:
		void fill(const CSCGeometry * theCSC,const CSCComparatorDigiCollection& comps, std::vector<std::vector<unsigned short int>> &chamlist);
};
...
class FillGIFWireInfo : public FillInfo
{
	...
	public:
		void fill(const CSCGeometry * theCSC,const CSCWireDigiCollection& wires, std::vector<std::vector<unsigned short int>> &chamlist);
};
