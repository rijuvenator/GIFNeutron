...
void FillGIFRecHitInfo::fill(const CSCGeometry * theCSC,const CSCRecHit2DCollection& recHits){
  reset();
...
void FillGIFCompInfo::fill(const CSCGeometry * theCSC,const CSCComparatorDigiCollection& comps){
  reset();
...
void FillGIFWireInfo::fill(const CSCGeometry * theCSC,const CSCWireDigiCollection& wires){
  reset();
