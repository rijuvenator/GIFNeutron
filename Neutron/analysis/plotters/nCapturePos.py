...
# Makes plots of the captured neutron position

# Get file keyed by event suffix
f = open('../files/pos_final_'+sys.argv[1])
...
canvasxy.save('../pdfs/hxy_'+sys.argv[1], ['.png','.pdf'])
...
canvasxz.save('../pdfs/hxz_'+sys.argv[1],['.pdf','.png'])
...
canvasyz.save('../pdfs/hyz_'+sys.argv[1],['.pdf','.png'])
...
canvasrz.save('../pdfs/hrz_'+sys.argv[1],['.pdf','.png'])
...
canvasDeutxy.save('../pdfs/hDeutxy_'+sys.argv[1],['.pdf','.png'])
...
canvasDeutxz.save('../pdfs/hDeutxz_'+sys.argv[1],['.pdf','.png'])
...
canvasDeutyz.save('../pdfs/hDeutyz_'+sys.argv[1],['.pdf','.png'])
...
canvasDeutrz.save('../pdfs/hDeutrz_'+sys.argv[1],['.pdf','.png'])
...
canvasNotDeutxy.save('../pdfs/hNotDeutxy_'+sys.argv[1],['.pdf','.png'])
...
canvasNotDeutxz.save('../pdfs/hNotDeutxz_'+sys.argv[1],['.pdf','.png'])
...
canvasNotDeutyz.save('../pdfs/hNotDeutyz_'+sys.argv[1],['.pdf','.png'])
...
canvasNotDeutrz.save('../pdfs/hNotDeutrz_'+sys.argv[1],['.pdf','.png'])
...
canvasTotxz.save('../pdfs/hxzTot_'+sys.argv[1],['.pdf','.png'])
...
canvasTotyz.save('../pdfs/hyzTot_'+sys.argv[1],['.pdf','.png'])
...
canvasTotrz.save('../pdfs/hrzTot_'+sys.argv[1],['.pdf','.png'])
...
canvasTotxy.save('../pdfs/hxyTot_'+sys.argv[1],['.pdf','.png'])
