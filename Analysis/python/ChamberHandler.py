...
class Chamber():
	...
	def setArea(self):
		...
		self.h = {'11': 152.0, '12': 174.49, '13': 164.16, '21': 189.66, '22': 323.06, '31': 169.70, '32': 323.06, '41': 149.42, '42': 323.06}#  44.5, 107.5,
		self.b = {'11': 19.14, '12':  51.00, '13':  63.40, '21':  54.00, '22':  66.46, '31':  61.40, '32':  66.46, '41':  69.01, '42':  66.46}# 19.14,  27.4,
		self.t = {'11':  47.4, '12':  83.74, '13':  92.10, '21': 125.71, '22': 127.15, '31': 125.71, '32': 127.15, '41': 125.65, '42': 127.15}#  27.4,  47.4,
		for ring in self.h.keys():
			areas[ring] = 6*0.5*self.h[ring]*(self.t[ring]+self.b[ring])
